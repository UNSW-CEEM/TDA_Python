...
var get_component_type = function(element_clicked){
    var tariff_type_panel = $(element_clicked).parents("div[id]").eq(1).prop('id');
    console.log(tariff_type_panel);
...
var add_component = function(tariff_type_panel){
    ...
    var to_insert = {component_type: templates}
    $.each(parameter_types, function(i, parameter_type){
